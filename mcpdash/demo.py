...
def demo_data():
    servers = [
        ...
        dict(name="filesystem", agent="claude", scope="user",
             ...
             projects_used={"obsidian-vault": 190, "website": 24}),
        ...
        dict(name="vault-bridge", agent="claude", scope="user",
             origin="~/.claude.json", transport="stdio",
             command="python C:/Users/me/mcp/vault_bridge_server.py",
    ...
    skill_list = [
        dict(name="notes-sync", source="vault", locked=False, calls=41,
             calls_30d=12, last_used="2026-08-23T10:00:00",
             description="Promote context from the current session into the shared notes vault so other agents can retrieve it."),
        dict(name="deep-research", source="vault", locked=False, calls=18,
             calls_30d=5, last_used="2026-08-19T16:30:00",
             description="Run a structured multi-source research pass and file the findings as a sourced report."),
        dict(name="standup", source="vault", locked=False, calls=9, calls_30d=3,
             last_used="2026-08-21T09:15:00",
             description="Pull the latest standup transcript and file it as a meeting note matching the established template."),
        dict(name="design-review", source="vault", locked=True, calls=6,
             calls_30d=1, last_used="2026-08-12T13:00:00",
             description="Review a page or component against the house design rules before it ships."),
        ...
        dict(name="notes-sync", source="plugin:vault-tools", locked=False,
             calls=0, calls_30d=0, last_used=None,
             description="Older copy of the notes-sync skill shipped with a plugin."),
    ]
    return servers, skill_list, history, {"demo": True, "host": "demo-machine",
